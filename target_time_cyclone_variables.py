...
audio_warn_str = 'Please ensure your sound is on at a comfortable level.\nIf you have any programs running in the background that can generate audio (Spotify, iTunes, internet, etc.), '+\
