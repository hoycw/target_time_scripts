...
rating_txt = visual.TextStim(win,text=rating_str,height=1.5,units='cm',
                                name='feedback_timing', color='black',pos=(0,3),wrapWidth=30)
...
rating_scale = visual.RatingScale(win, mouseOnly=True, pos=(0,-10),
